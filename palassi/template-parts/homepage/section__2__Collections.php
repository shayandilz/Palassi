<section
    ...
    <div class="col-lg-10 col-12 row justify-content-center justify-content-lg-start px-0 align-items-center pt-lg-5">
        ...
        <div class="row mt-lg-4">
            <div class="col-lg-12">
                <ul class="navPortfolio nav nav-fill overflow-x-scroll flex-lg-wrap flex-nowrap gap-2 border-bottom border-warning justify-content-start mb-4"
                                                    ...
                                                    <div class="row g-2">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="d-flex flex-column justify-content-end align-items-center h-100">
                                                                <h5 class="card-title text-warning fs-6 fw-light">Info : <?= get_the_title(); ?></h5>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
